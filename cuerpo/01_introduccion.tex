...
Cada curso académico, cientos de estudiantes de la \gls{upm} se enfrentan a una de las decisiones más determinantes de su formación: elegir el tema y el tutor de su \gls{tfg}, \gls{tfm} o tesis doctoral.
...
El Portal Científico de la \gls{upm}\footnote{Accesible públicamente en \url{https://portalcientifico.upm.es/}.} recoge, para cada miembro del \gls{pdi}, sus publicaciones, proyectos, líneas de investigación y actividad de supervisión.
