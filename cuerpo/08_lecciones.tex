\chapter[Lecciones aprendidas]{Problemas encontrados y lecciones aprendidas}
\label{ch:lecciones}
...
\textbf{Solución y lección.} El resumen se construye de forma incremental: la producción se agrupa por años y el modelo refina un resumen acumulado periodo a periodo, con deduplicación previa de resúmenes casi idénticos. El procedimiento acota el contexto por iteración, reparte el peso entre etapas de la carrera y produce biografías de granularidad homogénea entre perfiles muy distintos. La lección trasciende el caso: cuando el objeto a representar excede el contexto, la agregación incremental con estado explícito es preferible al truncado.
