...
\begin{table}[htbp]
    \centering
    \caption{Ejemplos reales (anonimizados) de heterogeneidad y ruido observados en el perímetro. Los nombres propios se han sustituido por marcadores; el resto del dato se reproduce literalmente.}
    \label{tab:ruido}
    \footnotesize
