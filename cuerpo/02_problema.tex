...
La Figura~\ref{fig:portal-1} recoge las secciones en que se divide la ficha —Presentación, Trayectoria profesional, Bibliometría, Proyectos y transferencia, Docencia, Red, y Resultados y actividad— y corresponde a la primera de ellas, la Presentación.
...
La Figura~\ref{fig:portal-2} amplía ese gráfico de temas, con uno de ellos resaltado para ilustrar cómo se presenta en la interfaz.

La Figura~\ref{fig:portal-3} muestra la última sección, Resultados y actividad, la más relevante para este trabajo, pues concentra la evidencia que el sistema explota: publicaciones, proyectos y trabajos supervisados.
