...
\begin{figure}[htbp]
    ...
    \caption[Flujo metodológico del sistema]{Flujo metodológico del sistema: preparación periódica del corpus (arriba) y atención de consultas en tiempo real (abajo).
