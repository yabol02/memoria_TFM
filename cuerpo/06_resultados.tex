...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{l X r}
        ...
        5. Indexación de keywords & Colección dispersa \texttt{researcher\_keywords} & $\sim$ 25 min \\
        6. Resúmenes anuales & Síntesis por año con \gls{llm} local & 29 h ($\approx$ 1 día y 5 h) \\
        7. Fusión e indexación & Biografía vigente y \texttt{researcher\_summaries} & \ $\sim$ 7h 30 min \\
        \bottomrule
    \end{tabularx}
\end{table}
