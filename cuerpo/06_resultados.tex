...
\begin{figure}[htbp]
      ...
      \resizebox{\textwidth}{!}{
            ...
            \node[proc, below=14mm of memgraph] (consol) {\textbf{Consolidación y biografías}\\[0.5mm] \footnotesize Ollama + Agno};
            ...
            \node[proc, below=18mm of indexa] (flask) {\textbf{\proyecto}\\[0.5mm] \footnotesize Flask + Gunicorn};
            \node[proc, below=14mm of minio2] (agentes) {\textbf{Agentes \gls{llm}}\\[0.5mm] \footnotesize Ollama (Qwen2.5)};
...
\pendiente{Completar, una vez disponible el índice definitivo: el número de perfiles enriquecidos e indexados en cada colección de Qdrant (\texttt{researcher\_\allowbreak summaries} y \texttt{researcher\_\allowbreak keywords}), la cobertura de biografía y de dominios por escuela, y los tiempos aproximados de cada fase del pipeline.}
